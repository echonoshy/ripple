...
#[openapi(
    ...
    tags(
        ...
        (name = "tasks", description = "Scheduled task and compatibility action endpoints"),
        (name = "task-triggers", description = "Scheduled task time trigger endpoints"),
        (name = "agent-delegations", description = "Cross-user delegated agent task endpoints"),
