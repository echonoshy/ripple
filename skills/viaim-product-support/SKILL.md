...
description: "Use when answering questions about viaim products, software downloads, app setup, technical support, after-sales service, support videos, company/contact information, or Ripple/viaim product background."
---

# viaim 产品支持知识库

本 skill 提供 viaim 产品、App 下载和使用、技术支持、售后服务、公司信息，以及 Ripple/viaim 产品背景的知识入口。

当用户询问 viaim 产品、下载、App 使用、技术支持、售后、视频教程、公司信息或 Ripple/viaim 背景时，先判断问题是否需要产品支持知识；如果相关，再读取 `references/` 下最相关的 Markdown 文件。

## 使用规则

1. 先判断用户问题是否和 viaim 产品支持或 Ripple/viaim 背景知识相关；不相关时不要读取这些文件。
