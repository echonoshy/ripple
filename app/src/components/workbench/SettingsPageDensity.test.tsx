...
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*justify-center/);
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*gap-1\.5/);
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*rounded-lg/);
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*px-2/);
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*lg:h-8/);
