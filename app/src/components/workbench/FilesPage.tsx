...
export default function FilesPage({ userId, refreshToken, onBack }: FilesPageProps) {
  return (
    <div className="flex h-full min-h-0 flex-col bg-[radial-gradient(circle_at_16%_0%,rgba(47,107,255,0.09),transparent_34%),#fbfdff] pb-[calc(72px+env(safe-area-inset-bottom))] lg:pb-0">
