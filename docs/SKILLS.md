...
- `skills/bilibili/*/pipeline.py`
- `skills/podcast/*/pipeline.py`
- `skills/lark/lark-slides/scripts/*.py`

Skill helper paths must be relative to their skill directory. Do not depend on removed backend packages such as the legacy Python `ripple` control plane or `interfaces.server`.
