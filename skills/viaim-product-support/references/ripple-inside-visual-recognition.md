...
Use `ripple-inside-chat-session.md` and `ripple-inside-model-selection.md` for the BrainCircuit cases. Use `ripple-inside-navigation.md` and `ripple-inside-skills-connectors.md` for the top Skills tab.
