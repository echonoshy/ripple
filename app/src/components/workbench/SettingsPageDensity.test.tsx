...
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*h-11 w-full/);
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*justify-start/);
assert.match(source, /settingsAccountActionButtonClass =[\s\S]*sm:h-9/);
